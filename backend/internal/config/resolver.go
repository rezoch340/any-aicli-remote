// Configuration resolution: flags, environment, canonical document, and the
// secret handoff files. This is the only place command-line and environment
// sources are merged into effective runtime settings.
