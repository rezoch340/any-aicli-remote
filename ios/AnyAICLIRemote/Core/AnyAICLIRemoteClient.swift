...
@MainActor
final class AnyAICLIRemoteClient {
    ...
    init(runtimeConfiguration: ClientRuntimeConfiguration = ClientRuntimeConfiguration()) {
    ...
    func rpc(_ method: String, params: [String: Any], timeout: TimeInterval? = nil) async throws -> Any {
    ...
    func rest(pathComponents: [String], method: String = "GET", query: [URLQueryItem] = [], body: [String: Any]? = nil) async throws -> [String: Any] {
    ...
    nonisolated static func incomingRequestCategory(_ object: [String: Any]) -> IncomingRequestCategory {
