...
final class WorkspaceAttachmentTests: XCTestCase {
  func testWorkspaceFileJSONAndURI() {
    let file = WorkspaceFile(
      json: ["path": "src/a b.swift", "name": "a b.swift", "size": 12], directory: false)
  ...
  func testPromptTextAndResourceLink() {
    ...
    let blocks = ACPWire.promptBlocks(text: "hi", attachments: [file])
  ...
  func testAttachmentOnlyAndSizeOmission() {
    ...
    let blocks = ACPWire.promptBlocks(text: "", attachments: [file])
