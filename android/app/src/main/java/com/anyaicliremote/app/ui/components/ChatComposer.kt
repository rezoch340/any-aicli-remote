            ...
            Surface(
                ...
                Column(Modifier.fillMaxWidth().padding(top = 10.dp, bottom = 8.dp)) {
                    if (attachments.isNotEmpty()) {
                        Row(
                            ...
                            attachments.forEach { file ->
                                FileCard(
                                    file = file,
                                    modifier = Modifier.width(260.dp).padding(end = 6.dp),
                    ...
                    Row(
                        ...
                        IconButton(onClick = onOpenFilePicker, modifier = Modifier.size(34.dp)) {
                            Icon(
                                Icons.Default.Add,
                        ...
                        FilledIconButton(
                            ...
                            enabled = busy || text.isNotBlank() || attachments.isNotEmpty(),
