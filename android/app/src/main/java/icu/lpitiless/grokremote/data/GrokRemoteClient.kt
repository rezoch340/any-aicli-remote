package icu.lpitiless.grokremote.data
...
class GrokRemoteClient {
    ...
    private val _notifications = MutableSharedFlow<JsonObject>(extraBufferCapacity = 256)
    ...
    private val listener = object : WebSocketListener() {
        ...
        override fun onMessage(webSocket: WebSocket, text: String) {
            ...
            _notifications.tryEmit(objectValue)
        }
