...
class AnyAICLIRemoteClient(
    private val productConfiguration: ClientProductConfiguration,
    ...
    suspend fun connect(profile: ServerProfile): JsonObject {
        ...
        val request = Request.Builder()
            ...
            .authorizeWithProductKey(productConfiguration, profile.key)
            .build()
        ...
        val result = rpc(
            ...
            params = ACPWire.initializeParameters(
                clientName = productConfiguration.clientName,
                clientVersion = productConfiguration.clientVersion,
            ),
    ...
    private suspend fun executeRest(
        ...
        val request = Request.Builder()
            ...
            .authorizeWithProductKey(productConfiguration, current.key)
...
internal fun Request.Builder.authorizeWithProductKey(
    productConfiguration: ClientProductConfiguration,
    pairingKey: String,
): Request.Builder = apply {
    header(productConfiguration.authorizationHeader, pairingKey)
}
